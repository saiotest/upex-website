...
export function TermsOfUse() {
	//!---- This page of Terms of Use is NOT USED, but a confluence link. ----!//
	return (
			...
			<main style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem' }}>
				<article style={{ backgroundColor: 'white', color: 'black', padding: '2rem', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', marginTop: '3rem' }}>
					...
					<ul>
						...
						<li>
							<p>
								<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to UPEX Quality LLC, 4278 NORTH HAZEL ST, CHICAGO.
							</p>
						</li>
						<li>
							<p>
